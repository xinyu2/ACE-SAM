...
def mixup_ace1_old(criterion, pred, y_a, y_b, lam, clambda, ncls, mask, f0):
    return lam * criterion(pred, y_a, clambda=clambda, nc=ncls, mask=mask, f0=f0) + (1 - lam) * criterion(pred, y_b, clambda=clambda, nc=ncls, mask=mask, f0=f0)
